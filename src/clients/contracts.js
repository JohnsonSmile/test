...
const NFTABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract MineContract",
        name: "",
        type: "address",
      },
    ],
...
const mineABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract ERC721Contract",
        name: "",
        type: "address",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct MineContract.Stake[]",
        name: "stakeDetail",
        type: "tuple[]",
      },
    ],
...
const contracts = {
  apesToken: "0x3be1a98317e708233e85b572b2c6349e8eb2e340",
  nftContract: "0x94fe0719B93d490CcB9E62c31C4843da01860C8B",
  mineContract: "0xf4c435fb9ca6f6116440d1f0d65f77849b87aa5c",
  APESABI: APESABI,
  NFTABI: NFTABI,
  MineABI: mineABI,
};
